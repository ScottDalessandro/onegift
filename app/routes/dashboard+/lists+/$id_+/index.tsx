...
// 	// Find the match for the parent layout route
// 	const parentMatch = matches.find(
// 		(m) =>
// 			m.pathname?.includes('/dashboard/lists/') &&
// 			m.pathname?.split('/').length === 4,
// 	)
// 	const list = parentMatch?.data?.list || {
// 		items: [],
// 		event: {},
// 		listType: {},
// 		title: '',
// 		createdAt: '',
// 	}
// 	const progress = parentMatch?.data?.progress ?? 0
// 	const categories = parentMatch?.data?.categories || { filled: 0, total: 5 }

// 	// Quick stats
// 	const itemCount = list.items?.length || 0
// 	const filledCategories = categories.filled
// 	const totalCategories = categories.total
// 	const profileCompletion = 100 // Placeholder, can be dynamic
// 	const daysUntilEvent = list.event?.date
// 		? Math.ceil(
// 				(new Date(list.event.date).getTime() - Date.now()) /
// 					(1000 * 60 * 60 * 24),
// 			)
// 		: null
...
// 						{list.event?.name || list.title}
// 					</h1>
// 					<div className="flex items-center gap-2 text-sm text-gray-500">
// 						{list.event?.date && (
// 							<span>{new Date(list.event.date).toLocaleDateString()}</span>
// 						)}
// 					</div>
// 				</div>
...
// 					<span className="font-medium text-gray-900">Registry Completion</span>
...
// 					/>
// 				</div>
// 				<div className="mb-2 rounded bg-blue-50 p-3 text-blue-900">
// 					<div className="font-medium">Next recommended step:</div>
// 					<div>
// 						Add Items (min. 5) – Helps friends find perfect gifts for your child
// 					</div>
...
// 					</li>
// 					<li className="flex items-center justify-between">
// 						<span>Set Up Digital Memories</span>
// 						<a href="memories" className="text-blue-600 hover:underline">
// 							Complete
// 						</a>
// 					</li>
// 					<li className="flex items-center justify-between">
...
// 					</li>
// 					<li className="flex items-center justify-between">
// 						<span>Complete Child's Profile</span>
...
// 						<div>
// 							<span className="font-semibold">Registry Name:</span> {list.title}
// 						</div>
// 						<div>
...
// 								{daysUntilEvent ?? '--'}
// 							</div>
// 							<div className="text-sm text-gray-500">Days Until Event</div>
// 						</div>
// 					</div>
// 				</div>
// 			</div>
